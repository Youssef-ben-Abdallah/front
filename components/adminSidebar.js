...
import SettingsIcon from '@mui/icons-material/Settings'; const AdminSidebar = () => {
        ...
        <div className="containerst">
            <Paper className="stylepop" >
                <MenuList >
                    <Divider />
                    <MenuItem>
                        <div onClick={() => router.push('/tableClient')}
                            className="stylediv">
                            <div>
                    ...
                    <Divider />
                    <MenuItem>
                        <div onClick={() => router.push('/tableServices')}
                            className="stylediv">
                            <div>
                                <ReceiptLongOutlinedIcon sx={{ color: '#991793' }} />
                            </div>
                            <div><Typography sx={{ color: 'gray' }}>Services</Typography></div>
                        </div>
                    </MenuItem>
                    <Divider />
                    <MenuItem>
                        <div onClick={() => { router.push('/tableOrders')}}
                            className="stylediv">
                            <div>
